...
pub fn generate_mandlebrot_set(
    canvas_w: usize,
    canvas_h: usize,
    x_min: f64,
    x_max: f64,
    ...
    for i in 0..canvas_h {
        ...
        for j in 0..canvas_w {
            let j_f64 = j as f64;
            let x = x_min + (x_max - x_min) * j_f64 / canvas_w_f64;
...
mod tests {
    ...
    fn test_generate_mandelbrot() {
        ...
        assert_eq!(generate_mandlebrot_set(canvas_w, canvas_h, x_min, x_max, y_min, y_max, max_iter), vec![96, 96, 96, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255]);
    }
}